...
function createDummyElement({
  ...
  interface IMakeTextElements {
    /**
     * a collection of @implements ITextNode[]
     */
    textNodes: ITextNode[];
  }

  interface IMakeImageElementsProps {
    imageNodeData: IImageNode[];
    parentNode: any;
  }

  // interface IMakeImageElements {
  //   index: number;
  //   DOM_svg: SVGSVGElement;
  //   DOM_rect: SVGRectElement;
  // }
...
export default function getSize({
  ...
  const cacheKey = JSON.stringify({ attributes, className, text });
